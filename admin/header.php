...
<!-- start upper header -->
<div class="container-fluid" style="background-color:#33381e; padding:8px;">
  <div class="container">
     <div class="row">
         <div class="col-md-4">
...
<div class="container-fluid" style="background-color:#fff;height:350px; width:auto;">
    <img src="../image/bloodbanksoftware.jpg" alt="Blood Bank System" class="img-responsive">
</div>
    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          <li><a href="#section1"> <span class="glyphicon glyphicon-envelope" > </span> Inbox </a></li>
         <li><a href="#"> <span class="glyphicon glyphicon-tint" > </span> Donor </a>
          <ul class="dropdown-menu">
              <li><a href="#">active donors</a></li>
              <li><a href="#">deactive donors</a></li>
            </ul>
          </li>
         <li><a href="#"> <i class="fa fa-hospital-o"></i> Need Blood</a>
         </li>
